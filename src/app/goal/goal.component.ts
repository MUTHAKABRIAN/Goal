...
export class GoalComponent implements OnInit {
  ...
  goals:Goal[] = [
    ...
    {id:3,name:'Get new Phone Case', description:'Diana has birthday coming up soon'},
    {id:4,name:'Get Dog Food', description:'pupper likes expensive sancks'},
    {id:5,name:'Solve math homework', description:'Damn math'},
    {id:6,name:'Plot my world domination plan', description:'cause I have victory and power in Jesus name'},
  ];
